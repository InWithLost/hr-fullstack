    ...
    <div class="py-10">
      <header>
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 class="text-3xl font-bold leading-tight text-gray-900">Редактирование специальности</h1>
        </div>
      </header>
...
async function loadSpecialty() {
  ...
  try {
    ...
    // Имитация загрузки данных
    setTimeout(() => {
      // Моковые данные для специальности
      const specialties = [
        { 
          id: '1', 
          name: 'Хирург', 
          category_id: 1, 
          description: 'Врач, специализирующийся на хирургических операциях', 
          education_level: 1,
          is_active: true,
          regional_salaries: [
            { city_id: 1, amount: 120000 },
            { city_id: 2, amount: 100000 },
            { city_id: 3, amount: 90000 }
          ]
        },
        { 
          id: '2', 
          ...
          category_id: 2, 
          description: 'Специалист по разработке пользовательских интерфейсов', 
          education_level: 1,
          is_active: true,
          regional_salaries: [
            { city_id: 1, amount: 180000 },
            { city_id: 2, amount: 150000 }
          ]
        },
        { 
          id: '3', 
          ...
          category_id: 3, 
          description: 'Преподаватель математики в школе', 
          education_level: 1,
          is_active: false,
          regional_salaries: [
            { city_id: 1, amount: 80000 },
            { city_id: 4, amount: 60000 }
          ]
        }
      ]
      ...
      if (specialty) {
        ...
        if (specialty.id === '1') {
          imagePreview.value = 'https://example.com/images/surgeon.jpg'
        }
      } else {
        error.value = 'Специальность не найдена'
      }
...
async function saveSpecialty() {
  ...
  try {
    ...
    setTimeout(() => {
      notification.show('Специальность успешно обновлена', 'success')
